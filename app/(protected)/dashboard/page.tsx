      ...
      <main className=" mt-8 space-y-4 ">
        <div className=" flex gap-4 md:flex-row flex-col">
          <Card className=" md:w-1/2 w-full">
            ...
            <CardContent>
              <p className="mb-4">
                ChatPDF allows you to have interactive conversations with your
                PDF documents. Simply upload a PDF, and start asking questions
                or discussing its content with our AI.
              </p>
              <Link href="/chats">
